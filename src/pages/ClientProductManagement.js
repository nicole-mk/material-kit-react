...
export default function ClientProductManagement() {
  ...
  const handleRegister = () => {
    navigate('/home/client-product-input', { replace: true });
  };
  ...
  const handleClick = (event) => {
    navigate('/home/client-product-input', {
      replace: true,
    });
  };
        ...
        <Card>
          <Scrollbar>
            ...
            >
              ...
              <Box sx={{ width: 1 / 2 }}>
                <Button variant="contained" onClick={handleRegister} style={{ marginRight: '10px' }}>
                  상품등록
                </Button>
              </Box>
            </Stack>
